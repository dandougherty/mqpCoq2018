...
(** Translate your solution for [plus_comm] into an informal proof:
    ...
    Theorem: Addition is commutative.
       For any n and m, n + m = m + n.

    Proof: By induction on n.
        First, suppose n = 0.
            (0 + m) = (m + 0)
        This is obvious by the definition of +.
        ...
        By the definition of +, this is equivalent to
            S (n' + m) = S (m + n')
        Which is then proven by the induction hypothesis. Qed.
...
(** Write an informal proof of the following theorem, using the
    ...
    Proof: By induction on n.
        First, suppose n = 0.
            beq_nat 0 0 = true
        This is obvious by the definition of a natural number.
  
        Next, suppose n = S n', where
            beq_nat n' n' = true
        We must show beq_nat S n' S n' = true.
        ???
*)
(** [] *)
