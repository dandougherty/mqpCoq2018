...
(fun (P Q R : Prop) (H : P /\ Q) =>
 match H with
 | conj H0 _ => fun H2 : Q /\ R => match H2 with
                                   | conj _ H4 => conj H0 H4
                                   end
 end).
(* Proof.
  intros P Q R [] []. split. apply H. apply H2.
  Show Proof.
Qed. *)
(** [] *)
...
Proof.
  intros X x y H P H1. rewrite <- H. apply H1.
Qed.
(** [] *)
...
Proof.
  intros X x y H. apply H. reflexivity.
Qed.
(** [] *)
