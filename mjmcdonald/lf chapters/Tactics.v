...
Theorem bool_fn_applied_thrice :
  ...
  f (f (f b)) = f b.
Proof.
  intros f b. destruct (f b) eqn:Hf.
  - destruct b eqn:Hb.
    + rewrite Hf. apply Hf.
...
Proof.
  ...
  rewrite H1. rewrite <- H2. rewrite <- beq_nat_refl with (n:=m). reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  induction l.
  - intros. inversion H.
  -simpl. intros. destruct (test x) eqn:Hx.
    + inversion H. rewrite <- H1. apply Hx.
