...
(* Theorem bag_count_sum : forall (s : bag),
  leb (count (hd O s) s) (count (hd O s) (sum s s)) = true.
Proof.
  intros s. induction s.
  - simpl. reflexivity.
  - simpl. rewrite <- beq_nat_refl. simpl. induction n.
    + simpl.
Qed. *)
...
Infinite. The definitions are both recursive so even though there are only two types of bool,
you can continually chain them.
IE: (Baz2 true (Baz2 false (Baz2 true (Baz1 (Baz1 (Baz2 false (..........
