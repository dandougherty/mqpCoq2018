...
Proof.
  intros. apply leb_complete in H. apply leb_complete in H0. apply leb_correct. apply le_trans with (n := m). apply H. apply H0.
Qed.
(** [] *)
...
Inductive nostutter {X:Type} : list X -> Prop :=
  ...
  | nostutter_2    : forall x y z, x <> y -> nostutter (y :: z) -> nostutter (x :: y :: z).
