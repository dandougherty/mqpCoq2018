...
Example test_incr1: (incr Z) = (D1 Z).
Proof. reflexivity. Qed.
Example test_incr2: (incr (D1 Z)) = (D (D1 Z)).
Proof. reflexivity. Qed.
Example test_incr3: (incr (D Z)) = (D1 Z).
Proof. reflexivity. Qed.
Example test_incr4: (incr (D (D1 Z))) = (D1 (D1 Z)).
Proof. reflexivity. Qed.
Example test_incr5: (incr (D1 (D1 Z))) = (D (D (D1 Z))).
Proof. reflexivity. Qed.
...
Fixpoint bin_to_nat (b : bin) : nat :=
  ...
  |Z => 0
  |D b' => 2 * (bin_to_nat b')
  |D1 b' => 1 + 2 * (bin_to_nat b')
  end.

Example test_b2n1: (bin_to_nat Z) = 0.
Proof. reflexivity. Qed.
Example test_b2n2: (bin_to_nat (D1 Z)) = 1.
Proof. reflexivity. Qed.
Example test_b2n3: (bin_to_nat (D Z)) = 0.
Proof. reflexivity. Qed.
Example test_b2n4: (bin_to_nat (D (D1 Z))) = 2.
Proof. reflexivity. Qed.
Example test_b2n5: (bin_to_nat (D1 (D1 Z))) = 3.
Proof. reflexivity. Qed.

(*Theorem test_b2n_incr: forall (b : bin),
